...
EIGRP AS 100                                                             |  OSPF Area 0                                                   |      BGP AS 64512/64513
                                                                         |                                                                |
+-----------+    10.1.0.0/30    +-----------+    20.1.0.0/30    +---------------+    30.1.0.0/30    +----------+    40.1.0.0/30    +--------------+    50.1.0.0/30    +-----------+
|  EIGRP-1  |-------------------|  EIGRP-2  |-------------------|  EIGRP-OSPF   |-------------------|  OSPF-1  |-------------------|   OSPF-BGP   |-------------------|   BGP-1   |
+-----------+                   +-----------+                   +---------------+                   +----------+                   +--------------+                   +-----------+
 (g0/0) .1                         .2 (g0/0)                       .2 (g0/1)                           .2 (g0/0)                       .2 (g0/0)                         .2 (g0/1)
   (Tunnel253:                         (g0/1) .1                       (g0/0) .1                           (g0/1) .1                       (g0/1) .1                         (Tunnel253:
 192.168.100.1)                                                                                                                                                            192.168.100.2)
     |                                                                                                                                                                          |
     +=================================================== GRE over IPsec Tunnel (Tunnel253) =================================================================================---+
                                                                   192.168.100.0/30
                                                                                                                                  |
